...
class Console():
    ...
    async def read_data_coroutine(self):
        return await self.loop.run_in_executor(None, self.proc_stdout.read, self.FRAME_DATA_SIZE)
    '''
